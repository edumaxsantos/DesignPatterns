package br.com.edumaxsantos.behavioral.state.example5;
    ...
    void landOnBy(Player p) {
        ...
        if(getOwner() == null) {
            ...
            if(p != getOwner()) {
                ...
                System.out.println(getOwner().getName() + " now has " + getOwner().getWorth() + " dollars");
            }
        }
        System.out.println(p.getName() + " has " + p.getWorth() + " dollars");
    }
}
