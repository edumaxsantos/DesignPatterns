...
public class FlyweightFactory {
    ...
    public static Button makeButton(String num) {
        ...
        if(treeMap.containsKey(num)) {
            ...
            2. Return an existing object [The same Button cannot
            be added multiple times to a container, and, Buttons
            cannot be cloned. So - this is only simulating the
            sharing that the Flyweight pattern provides.]
            */
    ...
    public static void report() {
        System.out.println("new Buttons - " + treeMap.size()
